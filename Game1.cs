    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            while (currentPillars < amountOfPillars)
            {
                ...
                pillar[currentPillars] = new Pillar(this, xAxisPillar, yAxisPillar, health, cState.Alive);
            ...
            wizard = new Wizard(this, 800, 700, 5, cState.Alive);
            ...
            for (int i= 0; i < amountOfMinions; i++)
            {
                ...
                minion[currentMinions] = new Minion(this, xAxisMinion, yAxisMinion, minionHealth, cState.Alive);
            ...
            monster = new BigMonster(this, 600, 300, 3, 1, cState.Alive);
